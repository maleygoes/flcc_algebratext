...
\ex{The mass of carbon dioxide $m$ in grams in a pressurized tank at room 
temperature is given by the formula $m=44x$ where $x$ is the volume of the tank in 
liters. A supplier can provide pressurized tanks with volumes of $5,10,20,$ or $50$ 
liters.  A chemist wrote down that he needed to order a tank with $176$ grams of 
carbon dioxide, but didn’t write down the volume tank this was based on. What size 
tank does he need to order?} \sol{5 liters}
\bigskip
