...
time $T$ in years that it will take to recoup the extra cost of installing the 
system is given by the formula $T=\frac{12000}{K-300}$ where $K$ is the annual cost 
of operating her current system. How long will it take to recoup the cost if her 
current system costs $\$1800$ to operate?} \sol{$8$ years}
